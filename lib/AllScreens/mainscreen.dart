...
import 'package:trip_plan_app/AllWidgets/divider.dart';
import 'package:geolocator/geolocator.dart';
import 'package:trip_plan_app/Allscreens/searchScreen.dart';
import 'package:trip_plan_app/Assistants/assistantMethods.dart';
import 'package:trip_plan_app/DataHandler/appData.dart';
import 'package:trip_plan_app/Map_geometry/directDetails.dart';
import 'package:trip_plan_app/services/places_service.dart';
import 'package:trip_plan_app/services/geolocator_service.dart';
import 'package:trip_plan_app/AllScreens/search.dart';
        ...
        ProxyProvider<Position, Future<List<Place>>>(
          update: (context, position, places) {
            return (position != null)
                ? placesService.getPlaces(position.latitude, position.longitude) : null;},
        )],
      child: MaterialApp(title: 'Travel App', theme: ThemeData(
